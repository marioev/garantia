...
//                        html+= caracteristica+"</td>";                        
                       ...
                       html += "<tr>";
                        ...
                        if(registros[i]["producto_foto"] != null && registros[i]["producto_foto"] !=""){
                            ...
                            mimagen = "<img src='"+base_url+"resources/images/productos/thumb_producto.jpg' class='img img-"+formaimagen+"' width='50' height='50' />";
                        }
                        html += mimagen;
                        html += "</div>";
                       ...
                       //+registros[i]["estado_descripcion"]+
                        html += "</td>";
		        html += "<td class='no-print'>";
                        html += "<a href='"+base_url+"producto/edit/"+registros[i]["producto_id"]+"' target='_blank' class='btn btn-info btn-xs' title='Modificar Información'><span class='fa fa-pencil'></span></a>";
...
function cabecera_tabla() {
    ...
    chtml += "<th  role='columnheader' >Presentación</th>";
