    ...
    $.ajax({url: controlador,
        ...
        success:function(result){
            ...
            if(resultado != null){
                ...
                html +=                         ""+resultado[0]['producto_nombre']+" <br>"
                ...
                html +=                            "<p class='color-text'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ea quis dolore dicta nemo optio cum sed? Minima officia alias consequatur tenetur reiciendis, rerum adipisci rem assumenda illo consequuntur recusandae distinctio.</p>"
                html +=                        "</div>"
                html +=                    "</div>"
                html +=                "</div>"
