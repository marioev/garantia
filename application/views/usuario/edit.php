				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estado_id" value="<?php echo ($this->input->post('estado_id') ? $this->input->post('estado_id') : $usuario['estado_id']); ?>" class="form-control" id="estado_id" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tipousuario_id" class="control-label">Tipousuario Id</label>
						<div class="form-group">
							<input type="text" name="tipousuario_id" value="<?php echo ($this->input->post('tipousuario_id') ? $this->input->post('tipousuario_id') : $usuario['tipousuario_id']); ?>" class="form-control" id="tipousuario_id" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="parametro_id" value="<?php echo ($this->input->post('parametro_id') ? $this->input->post('parametro_id') : $usuario['parametro_id']); ?>" class="form-control" id="parametro_id" />
						</div>
					</div>
				</div>
			</div>
