            ...
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="form-group">
                        <input type="text" name="usuario_nombre" value="<?php echo $this->input->post('usuario_nombre'); ?>" class="form-control" id="usuario_nombre" autofocus required autocomplete="off" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
                    ...
                    <div class="col-md-6">
                        <label for="usuario_email" class="control-label"><span class="text-danger">*</span> Email</label>
                        <div class="form-group">
                            <input type="email" name="usuario_email" value="<?php echo $this->input->post('usuario_email'); ?>" class="form-control" id="usuario_email" required autocomplete="off" />
                            <span class="text-danger"><?php echo form_error('usuario_email');?></span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label for="user_login" class="control-label"><span class="text-danger">*</span> Login</label>
                        <div class="form-group">
                            <input type="text" name="usuario_login" value="<?php echo $this->input->post('usuario_login'); ?>" class="form-control" id="usuario_login" required autocomplete="off" />
                    ...
                    <div class="col-md-3">
                        <label for="usuario_clave" class="control-label"><span class="text-danger">*</span> Repetir Clave</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <img src="<?php echo site_url('resources/images/usuarios/default.jpg')?>" id="previewing" class="img-responsive center-block">
                    </div>
                </div>
            </div>
