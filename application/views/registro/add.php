          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="registro_serie" value="<?php echo $this->input->post('registro_serie'); ?>" class="form-control" id="registro_serie" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="registro_fecha" value="<?php echo $this->input->post('registro_fecha'); ?>" class="has-datepicker form-control" id="registro_fecha" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="registro_vigencia" value="<?php echo $this->input->post('registro_vigencia'); ?>" class="form-control" id="registro_vigencia" />
						</div>
					</div>
				</div>
			</div>
