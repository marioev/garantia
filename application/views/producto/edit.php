                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group" style="display: flex">
                            <select name="categoria_id" class="form-control" id="categoria_id" onchange="mostrar_subcategoriaproducto(this.value)">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <select name="estado_id" class=" form-control" id="estado_id">
                                <option value="1" <?php echo $elestado1; ?>>ACTIVO</option>
                                <option value="2" <?php echo $elestado2; ?>>INACTIVO</option>
                                <?php 
